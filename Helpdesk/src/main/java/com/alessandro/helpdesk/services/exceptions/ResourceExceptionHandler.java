package com.alessandro.helpdesk.services.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> objectNotFoudException(ObjectNotFoundException ex, HttpServletRequest request){
	...
	public ResponseEntity<StandardError> dataIntegrityViolationExceptionn(DataIntegrityViolationException ex, HttpServletRequest request){
